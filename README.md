...
see a list of all available configuration options, or refer to
[action config doc](./docs/actions_config.md) to learn how configuration
options are handled.
...
Please see [actions configuration doc](./docs/actions_config.md) for extra
details on how actions can be configured.
