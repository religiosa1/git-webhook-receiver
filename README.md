...
By default, app exposes inspection/admin HTTP endpoints, unless 
`web_admin: false` is set in the config. This endpoints allows you to get the 
status/output of a pipeline, list pipelines, or go through the app logs.
